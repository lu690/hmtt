      ...
      <template v-else>
        ...
        <div class="article-detail" v-if="!!article.art_id">
          ...
          <van-cell class="user-info" center :border="false">
            ...
            <!-- <FollowUser :is_follow="article.is_follow"></FollowUser> -->
            <!-- <FollowUser

              :is_follow="article.is_follow"
              @input="article.is_follow = $event"
            ></FollowUser> -->

            <FollowUser
              v-model="article.is_follow"
...
export default {
  ...
  async created () {
    ...
    this.$nextTick(() => {
      ...
      if (arr.length === 0) return // 防御性代码，更好点
      const arr1 = []
